...
export const SEGMENT_HOVER_COLOR = 'rgba(0, 102, 255, 0.6)';
export const SEGMENT_SELECTED_COLOR = '#CC0000';
export const SEGMENT_HOVER_WIDTH = 3;
...
export const TEXT_CURSOR_BLINK_INTERVAL_MS = 530;
